 ...
 * - {@link LexInteger} - Wrapper that asserts a number is a safe integer at
 *   construction time and encodes as a CBOR uint/negint token
 *
 ...
 * number (any finite value), string, boolean, null, Cid, Uint8Array,
 * {@link LexFloat}, or {@link LexInteger}.
 *
 ...
 * float distinction matters, or in {@link LexInteger} to assert at the call
 * site that the value is integral.
 *
 * @param value - The value to check
 ...
 * isLexScalar(new LexInteger(42)) // true
